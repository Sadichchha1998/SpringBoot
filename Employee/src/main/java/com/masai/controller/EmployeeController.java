...
public ResponseEntity<Employee> registerEmployee(@RequestBody Employee emp){
	...
	return new ResponseEntity<Employee>( empService.registerEmployee(emp),
			HttpStatus.CREATED);
...
public ResponseEntity<Employee> getEmployeeById(@RequestParam ("id") int id){
	...
	return new ResponseEntity<Employee>( empService.getEmployeeById(id),
			HttpStatus.OK);
...
public ResponseEntity<List<Employee>> getAllEmployees(@RequestBody Employee employee){
	...
	return new ResponseEntity<List<Employee>>( empService.getAllEmployeeDetails(),
			HttpStatus.OK);
...
public ResponseEntity<Employee> deleteEmployeeById(@PathVariable ("id") int id){
	...
	return new ResponseEntity<Employee>( empService.deleteEmployeeById(id),
			HttpStatus.OK);
